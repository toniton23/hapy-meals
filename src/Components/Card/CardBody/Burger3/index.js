...
import {Stars, bur2} from '../../../../Utils/Asets';

const index = () => {
  return (
    <View>
      <View style={styles.card}></View>
      <Image source={bur2} style={styles.topimage} />
      <View style={styles.wrappertext}>
        <View>
          <Text style={styles.textasian}>Red Meat Burger</Text>
        </View>
        <View style={{flexDirection: 'row'}}>
          <Image source={Stars} style={styles.stars} />
          <Text style={styles.text48}>4.7 </Text>
          <Text style={{marginLeft: 8}}>(129 ratings) </Text>
        </View>
      </View>
    </View>
  );
